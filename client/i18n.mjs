...
export const DICT = {
	zh: {
		...
		"nav.submit.markerStale": "评审已投递为草稿；但标记推进失败 —— 下次评审仍从原基线开始。",
		...
		"viewer.kind.binaryPreview": "未变更的二进制文件（预览不展示二进制内容）",
	...
	en: {
		...
		"nav.submit.markerStale": "Review delivered as a draft; but the marker could not be advanced — the next review still starts from the previous base.",
		...
		"viewer.kind.binaryPreview": "Unchanged binary file (binary content is not previewed)",
